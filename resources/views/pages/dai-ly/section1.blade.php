<div class="section1 position-relative d-flex justify-content-center align-items-center">
    ...
    @endif
        <div id="carouselExampleControls" class="carousel slide w-100 d-none d-md-block" data-bs-ride="carousel" data-interval="20000">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{asset('images/dai-ly/sec1/13.jpg')}}" class="img-slide" alt="img-slide" data-url="https://www.youtube.com/watch?v=U6EQrgTtO20">
                </div>
                <script>
                    $(document).ready(function () {
    ...
    <div id="carousel_mobile" class="carousel slide w-100 d-md-none" data-bs-ride="carousel" data-interval="5000">
        <div class="carousel-inner">
            <div class="carousel-item  active">
                <img src="{{asset('images/dai-ly/sec1/13-mobile.jpg')}}" class="img-slide" alt="img-slide" data-url="">
            </div>
            <script>
                $(document).ready(function () {
                    $('.dr-link').click(function () {
        ...
        <button class="carousel-control-prev button-shake d-none" type="button" data-bs-target="#carousel_mobile"
                data-bs-slide="prev">
            <img src="{{asset('images/arrow-l.png')}}" alt="" style="">
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next button-shake d-none" type="button" data-bs-target="#carousel_mobile"
                data-bs-slide="next">
            <img src="{{asset('images/arrow-r.png')}}" alt="" style="">
            <span class="visually-hidden">Next</span>
        </button>
