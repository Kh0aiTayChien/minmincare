<div class="sec4-DL row-test">
    <object data="{{asset('images/dai-ly/sec4/Group 3178.svg')}}" class="headersec4-DL"></object>
    <object data="{{asset('images/dai-ly/sec4/4. Quy trình-PC.png')}}" class="contentsec4-DL col-12"></object>
</div>
...
{{--    </div>--}}
    <img src="{{asset('images/dai-ly/sec4/4. Quy trình-Mobile.png')}}" class="contentsec4mb-DL col-10">
</div>
