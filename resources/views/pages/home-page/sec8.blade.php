<div class="sec8">
    {{--    <object data="{{asset('images/sec8/Asset 1.png')}}" class=" col-sm-4 col-xxl-4 col-7"></object>--}}
                        ...
                        <div class="card rounded-custom shadow-effect me-1" style="width:20rem; "><a
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-content-center justify-content-center mitr-medium ">
                                    <a href="{{route('kien-thuc.show',['slug' => $article->slug])}}" class="btn green-border green-text btn-sm mb-3 rounded-pill btn-long button-shake">XEM
                                        CHI TIẾT</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-3 d-flex justify-content-center align-content-center">
                    <div class="card rounded-custom shadow-effect me-1" style="width:20rem; "><a
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text ">{{ preg_replace('/<[^>]*>/', '', \Illuminate\Support\Str::limit(strip_tags($article->content), 65)) }}</p>
                            <div class="d-flex align-content-center justify-content-center mitr-medium ">
                                <a href="{{route('kien-thuc.me-sau-sinh.show',['slug' => $article->slug])}}" class="btn green-border green-text btn-sm mb-3 rounded-pill btn-long button-shake">XEM
                                    CHI TIẾT</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-3 d-flex justify-content-center align-content-center">
                    <div class="card rounded-custom shadow-effect me-1" style="width:20rem; "><a
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text ">{{ preg_replace('/<[^>]*>/', '', \Illuminate\Support\Str::limit(strip_tags($article->content), 65)) }}</p>
                            <div class="d-flex align-content-center justify-content-center mitr-medium ">
                                <a href="{{route('kien-thuc.dinh-duong-cho-con.show',['slug' => $article->slug])}}" class="btn green-border green-text btn-sm mb-3 rounded-pill btn-long button-shake">XEM
                                    CHI TIẾT</a>
                            </div>
                        </div>
                    </div>
