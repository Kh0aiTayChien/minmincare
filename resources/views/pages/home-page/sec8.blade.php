<div class="sec8">
    ...
    <div class="contentsec8">
        ...
        <a href="{{asset('kien-thuc/me-sau-sinh')}}">
            <img src="{{asset('images/kien-thuc/sec2/sau-sinh.png')}}" class="imgsec8 col-sm-4 col-8 col-xxl-3 shadow-test button-shake"></a><br>
        <a href="{{asset('kien-thuc/dinh-duong-cho-con')}}">
            <img src="{{asset('images/kien-thuc/sec2/dinh-duong.png')}}" class="col-8 col-sm-4 col-xxl-3 imgsec8 shadow-test button-shake"></a>
    </div>
</div>
