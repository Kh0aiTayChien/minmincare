<div class="secp-TT">
    <div class="row-test mb-4">
        ...
        <a href="{{asset('kien-thuc/cham-soc-da')}}" class="col-xxl-4 col-sm-4 col-9 menuKT shadow-test"><img
                src="{{asset('images/kien-thuc/sec2/cham-soc-da-active.png')}}" class="col-12 button-shake"></a>
    </div>
    @foreach($articles as $article)
        <div class="card mb-4 mt-4 border-0 ">
            <a href="{{route('kien-thuc.cham-soc-da.show',['slug' => $article->slug])}}" style="text-decoration: unset; color: unset">
                <div class="row">
