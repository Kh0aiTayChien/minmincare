...
{{--    <object data="{{asset('images/gioi-thieu/sec6/Group 22.png')}}" class="headersec6mb-GT"></object>--}}
    <p class="header-test-orange-mb">Bắt đầu từ con người</p>
    <p class="header-test-green-mb">MỤC TIÊU CŨNG</p>
    <p class="header-test-green-mb">VÌ CON NGƯỜI</p>
    ...
    <p class="contentsec2mb-GT"><span class="bold-text">Sau hơn 7 năm</span> kinh doanh sản phẩm Min Min Care, Nga tìm
        ...
        hợp khi bận rộn từ chuyện con cái, gia đình, bạn bè cho đến công việc.</p>
    <p class="contentsec2mb-GT">Nga thấu hiểu điều đó nên đã và đang trên con đường thông qua Min Min Care để trở thành
       người mang đến niềm cảm hứng cho họ, giúp họ có được nguồn dinh dưỡng toàn diện từ sản phẩm ngũ cốc cũng như giúp
       họ tìm được niềm vui, niềm hạnh phúc trong cuộc sống này.</p>
</div>
    ...
    <div class="row-test containersec6-GT-test">
        ...
        <div class="col-md-5 col-xxl-4 contentsec6-GT-test">
            <p class="textsec6-GT-test">Thời gian đầu do chưa có vốn nên không dễ dàng để vận hành. Nhưng Nga vẫn giữ
                ...
                trước.</p>
            <p class="textsec6-GT-test">Để có được như ngày hôm nay thì Nga đã được ủng hộ và hỗ trợ rất nhiều từ chồng,
                người thân trong gia đình, bạn bè, nhân công sản xuất và những đại lý nhà phân phối. Mọi người đã giúp
                đưa sản phẩm tới gần hơn với người tiêu dùng và đồng hành trong hành trình suốt 7 năm với Min Min Care.
            </p>
            <p class="textsec6-GT-test"><span class="bold-text">Sau hơn 7 năm</span> kinh doanh sản phẩm Min Min Care,
                Nga tìm thấy được ý nghĩa và giá trị tích cực của việc mình hướng đến. Bất kỳ người mẹ nào cũng mong
                muốn dành những điều tốt nhất cho đứa con của mình, nhưng không phải họ lúc nào cũng đủ thời gian để có
                được một giải pháp phù hợp khi bận rộn từ chuyện con cái, gia đình, bạn bè cho đến công việc.</p>
            <p class="textsec6-GT-test">Nga thấu hiểu điều đó nên đã và đang trên con đường thông qua Min Min Care để
