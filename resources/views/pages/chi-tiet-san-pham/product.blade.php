<div class=" container-fluid custom-padding custom-margin ">
    <div class="row">
        <div class="media-product col-6 offset-3">
                        ...
                        <script>
                            $(document).ready(function() {
                                ...
                                $('.item.video ').click(function() {
                                    ...
                                    let videoHtml = '<iframe id="videoPlayer" width="100%" height="100%" src="' + videoUrl + '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
        ...
        <div class="description-product col-6 offset-3">
            <div class="card mb-3">
                <div class="card-body">
                    <div class="main-info h2 mitr-big">
                    ...
                    <div class="h3 mitr-big mt-2">
                        Giá niêm yết: {{ number_format($product->price, 0, ',', '.') }}vnd
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="main-info h2 text-center mitr-big">
                        MÔ TẢ SẢN PHẨM
                    </div>
